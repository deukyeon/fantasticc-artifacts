...
void
OptimisticTransactionRocksDB::InitializeOptions(utils::Properties &props)
{
...
void
OptimisticTransactionRocksDB::Init()
{}

void
OptimisticTransactionRocksDB::Close()
{}

void
OptimisticTransactionRocksDB::Begin(Transaction **txn)
{
   if (*txn == NULL) {
...
int
OptimisticTransactionRocksDB::Commit(Transaction **txn)
{
...
int
OptimisticTransactionRocksDB::Read(Transaction                    *txn,
...
int
OptimisticTransactionRocksDB::Scan(Transaction                      *txn,
                                   const std::string                &table,
                                   const std::string                &key,
                                   int                               len,
                                   const std::vector<std::string>   *fields,
...
int
OptimisticTransactionRocksDB::Update(Transaction         *txn,
                                     const std::string   &table,
                                     const std::string   &key,
...
int
OptimisticTransactionRocksDB::Insert(Transaction         *txn,
                                     const std::string   &table,
                                     const std::string   &key,
                                     std::vector<KVPair> &values)
{
...
int
OptimisticTransactionRocksDB::Delete(Transaction       *txn,
                                     const std::string &table,
                                     const std::string &key)
{
   assert(txn != NULL);
