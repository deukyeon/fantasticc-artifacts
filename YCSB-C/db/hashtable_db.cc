...
int
HashtableDB::Read(const string         &table,
                  const string         &key,
...
int
HashtableDB::Scan(const string           &table,
                  const string           &key,
                  int                     len,
                  const vector<string>   *fields,
...
int
HashtableDB::Update(const string   &table,
                    const string   &key,
...
int
HashtableDB::Insert(const string   &table,
                    const string   &key,
                    vector<KVPair> &values)
{
   string          key_index(table + key);
...
int
HashtableDB::Delete(const string &table, const string &key)
{
   string          key_index(table + key);
