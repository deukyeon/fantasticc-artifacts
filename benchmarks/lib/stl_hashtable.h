...
template<class V, class MA, class PA>
V
StlHashtable<V, MA, PA>::Get(const char *key) const
{
...
template<class V, class MA, class PA>
bool
StlHashtable<V, MA, PA>::Insert(const char *key, V value)
{
   if (!key)
      return false;
...
template<class V, class MA, class PA>
V
StlHashtable<V, MA, PA>::Update(const char *key, V value)
{
...
template<class V, class MA, class PA>
V
StlHashtable<V, MA, PA>::Remove(const char *key)
{
   typename Hashtable::const_iterator pos = table_.find(String::Wrap(key));
   if (pos == table_.end())
      return NULL;
